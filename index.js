...
console.log(addArtist(artists, 'Steve Stafford', '2002-2022', 'Full Stack Development', 'African-merican', 'I have a background in custom service at Big Retail Chain. I am attending to become a Frontend Developer.'));
...
function lotsOfArt(array) {
  const seniorPainters = []; 
  for (let i = 0; i < array.length; i++) {
    if(array[i].paintings > 100) {
    seniorPainters.push(array[i].name)
    }
  }
  return seniorPainters;
}
